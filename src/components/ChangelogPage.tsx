    ...
    groups: [
      {
        ...
        items: [
          ...
          'The sign in screen offers to make you an account. Creating one was a line of underlined text below the Sign in button, the weight of a footnote on the one screen whose job is to tell two kinds of visitor apart. It is a button now, under a rule that says new here, and only the colour says which of the two most people want.',
