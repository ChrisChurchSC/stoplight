...
const RELEASES: Release[] = [
  {
    ...
    groups: [
      ...
      },
      {
        tag: 'Fixed',
        items: [
          'A deliverable no longer jumps when you change its asset count. The card sat centred in the space reserved for its posts, so adding one asset slid the card half a post down, under the cursor you were clicking with. It stays exactly where it is now.',
