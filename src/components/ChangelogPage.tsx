    ...
    groups: [
      {
        ...
        items: [
          ...
          'The inspector lists every card on the board as layers, grouped by what each card does and using the same three words as the toolbar. Each row carries the card's own mark: a deliverable shows its channel, a context card its kind. Smart objects nest their contents underneath them, and a context card that is not attached to the campaign says so. Click a row to select that card. It is what the panel shows whenever nothing is selected, in both a new campaign and a built one. It used to list deliverables only, so context cards and smart objects were invisible unless you could see them on the canvas.',
