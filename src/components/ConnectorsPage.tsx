...
/**
 * Connect Magnetic Matter to Claude — the MCP connect card, in the shape every MCP server
 * uses: the server reference to copy, a tab per client (Claude Code / Desktop / Claude.ai),
 * and the exact command/config to paste. Magnetic Matter runs locally over stdio (the browser
  ...
  return (
    <div className="page">
      <div className="page-body mcpc-body">
        <div className="mcpc">
          <h1 className="mcpc-title">Connect Magnetic Matter to Claude</h1>
          ...
          {tab === 'code' ? (
            ...
            <p className="mcpc-note">
              Claude.ai connects to hosted (HTTP) servers. Magnetic Matter runs locally over stdio, so connect it through{' '}
