 ...
 *
 * The agentic connect itself lives in the desktop app (the Magnetic Matter MCP bridge —
    ...
    <>
      ...
      <div className="assist" role="dialog" aria-label="Set up with Claude">
        ...
        <div className="assist-note">
          In the Claude desktop app, say <strong>"set up my brand in Magnetic Matter"</strong>. Keep this
