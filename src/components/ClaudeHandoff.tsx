 ...
 *
 * The agentic connect itself lives in the desktop app (the ItsyBitsy MCP bridge —
    ...
    <>
      ...
      <div className="assist" role="dialog" aria-label="Set up with Claude">
        ...
        <div className="assist-note">
          In the Claude desktop app, say <strong>"set up my brand in ItsyBitsy"</strong>. Keep this
