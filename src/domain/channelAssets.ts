...
export const CHANNEL_ASSETS: Record<ChannelId, AssetSlot[]> = {
  ...
  website: [med('hero', 'Hero image 16:9', '16:9', ['16:9'], ['image']), med('og-image', 'OG image 1.91:1', '1.91:1', ['1.91:1'], ['image']), cpy('headline', 'Headline', 60), cpy('body', 'Body')],
...
export const CHANNEL_SOURCE: Record<ChannelId, SpecSource> = {
  ...
  website: { url: 'OG image 1200×630 (1.91:1)', verified: PLATFORM, confidence: 'medium' },
