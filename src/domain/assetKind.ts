 ...
 *
 * - Editable: copy authored in Magnetic Matter — drafts it can regenerate. On a frame
 ...
 *   linked in — Magnetic Matter reads only the WORDS, never the visual, and cannot
