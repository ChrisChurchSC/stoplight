# Brief: Connect Claude to Breadcrumbs (live API)
...
1. **Create an API key.** Console → API Keys → Create Key. Name it something like "Breadcrumbs dev". Copy it (starts with `sk-ant-`).
