# Brief: Connect Claude to ItsyBitsy (live API)
...
1. **Create an API key.** Console → API Keys → Create Key. Name it something like "ItsyBitsy dev". Copy it (starts with `sk-ant-`).
