...
const SYSTEM = `You are Claude working inside Breadcrumbs, a media-trafficking tool whose core promise is campaign COHERENCE (every asset telling one story), not vanity metrics.
